 ...
 * тільки цей ендпоїнт.
 *
 * Авторизація (рішення CEO 2026-08-01): вирішує CEO; owner теж може;
 * заявку самого CEO вирішує лише owner — щоб ніхто не погоджував себе.
 */
...
export const requestSchema = z
  .object({
    ...
    /** Кого стосується запис — лише для record/revise (owner/CEO). */
 ...
 * «Надіслати», заявка лишалась у базі, а CEO про неї не дізнавався ніколи.
...
async function handleSubmit(params: {
  ...
  // pending не міг би вирішити ніхто (сам собі — заборонено, CEO заявку
  // власника — теж). Тестове подання CEO 2026-08-07 застрягло саме так.
  // Заявка CEO лишається pending — її вирішує власник.
...
/* ============ Керівництво веде запис ЗА людину (owner/CEO) ============ */

/**
 * Внести / змінити / прибрати чужу відсутність.
 *
 * Чому через сервер, хоча RLS і так пускає лише owner/CEO: раніше ці три дії
 * йшли прямо з браузера і МОВЧАЛИ — CEO ставив людині відпустку, а людина
 ...
 * (owner/CEO) лишаються єдиним джерелом права на дію — окремої перевірки ролі
