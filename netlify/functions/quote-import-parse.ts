...
const DEVELOPER_PROMPT = [
  ...
  "comment = the client's own comment for that row, verbatim and short (for Word documents — the requirements summary described above). notes = your remark about what was unclear.",
