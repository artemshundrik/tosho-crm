...
//
// КАДАНС. Крон викликає це ЩОГОДИНИ (scripts/design-timer-reminders-cron.sql).
// Доти було раз на добу о 18:10 — і 8-годинна межа працювала лише для таймерів,
// запущених до ранку: усе пізніше перетинало 8 год після вечірньої перевірки й
// висіло до наступного вечора. Якщо колись знову захочеться зрідити перевірку,
// пам'ятай: «стеля 8 годин» тримається саме кадансом, а не цією константою.
