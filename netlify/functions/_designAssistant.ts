...
export const HELP_TEXT = [
  ...
  "• що робив Антон вчора?",
  "• як справи в Лєни?",
  "",
  "<b>Гроші на AI</b>",
  "• скільки витратили на AI?",
  "• скільки лишилось кредитів?",
  "",
  "<b>Дедлайни</b>",
  ...
  "«а по Марʼяні?» — я доповню попереднє питання. Контекст живе 30 хвилин.",
  "",
