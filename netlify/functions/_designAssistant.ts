...
export const HELP_TEXT = [
  "<b>Що можна питати про дизайн</b>",
  "",
  "<b>Стан зараз</b>",
  "• скільки задач у роботі?",
  "• скільки в прогресі у Ірини?",
  "• покажи задачі в правках",
  "• які задачі найдовше без руху?",
  "",
  "<b>За період</b>",
  "• скільки задач створили сьогодні?",
  "• скільки задач було на тому тижні?",
  "• скільки затвердили за місяць?",
  "• скільки Петро зробив за тиждень?",
  "",
  "<b>Правки і час</b>",
  "• скільки правок за тиждень?",
  "• які правки без відповіді?",
  ...
  "• як справи в Ірини?",
  "",
  "Періоди: сьогодні, вчора, цей / минулий тиждень, цей / минулий місяць, весь час.",
  "Поки що я знаю тільки дизайн-задачі — прорахунки й фінанси не питай.",
].join("\n");
