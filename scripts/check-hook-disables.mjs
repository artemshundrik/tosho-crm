 ...
 *
 * 29 з 2026-08-28: разом із правою панеллю «Ролей і доступів» пішов ефект
 * синхронізації редагування з вибраною людиною — заглушка зникла з нею.
 * Опускаємо, щоб ратчет тримав новий рівень, а не старий дозвіл.
 */
