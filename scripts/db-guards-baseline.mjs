 ...
 *
 * ДВА РЯДКИ НИЖЧЕ — СПРАВЖНІЙ БОРГ, А НЕ ВИНЯТОК. Обидві політики кличуть
 * ДВОАРГУМЕНТНІ `is_workspace_admin/owner(workspace_id, auth.uid())`, у яких
 * гейта немає (на відміну від одноаргументних). Тобто деактивований адмін може
 * видалити членство, а деактивований власник — змінити роль. Зараз це нікого не
 * зачіпає: обидва заблоковані співробітники — `member`. Заведено як REQ-258;
 * коли полагодять, рядки звідси прибирають.
 */
