...
Коміт **дрібний** (до 3 файлів і 80 рядків) і **без трейлера** — `post-commit`
друкує рядок: запиши це в полицю «Дрібниці: <напрям>» і закрий адресою пункта.
...
А от дрібний коміт без трейлера — майже завжди пропущений рядок на полиці.
