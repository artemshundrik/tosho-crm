 ...
 *
 * ЧОГО ПОШУК НЕ ЗНАЙДЕ НІКОЛИ, І ЦЕ НЕ НАША ПОЛОМКА. Близько 5% рядків прайсу
 * (366 із 6752, замір 12.09.2026) не мають ні фото, ні посилання, бо на сайті
 * їх немає ЗОВСІМ: пошук під логіном віддає на такий артикул порожньо. Перевірено
 * пробою на 18 таких артикулах — жодного влучення, — з контрольним запитом на
 * чотирьох рядках, де фото є: усі чотири знайшлись із фото. Тобто Папірус продає
 * з прайсу більше, ніж публікує карточками, і різниця йде саме по SKU, не по
 * родині: `STA3202-10` на сайті є, `STA3202-3` немає. Шукати тут нічого, і
 * `minCoverage` тому стоїть на 0,9 — нижче фактичних 94,6%.
 *
