 ...
 * відкриється справжня стіна: `try/finally` і `throw` усередині `try/catch`,
 * межі компілятора 1.0. Тому частина правил там і далі мовчить, а число нижче —
 * не ввесь борг, а його видима частина. Просто «видима» тепер більша, ніж було.
 *
