...
# Необов'язковий четвертий аргумент — де відрізати маску знизу, часткою висоти
# КАДРУ. Потрібен там, де рендер має м'яку тінь під предметом: у горнятка вона
# тієї самої яскравості, що кераміка (заміряно: тінь 208-238, кераміка 211-228),
# тож ані порогом, ані ерозією її не відділити — вона торкається дна по всій
# ширині. Єдине, чим вона відрізняється, — це те, що вона НИЖЧЕ предмета.
