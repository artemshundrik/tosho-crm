...
const EXPLAINED = {
  ...
  "@phosphor-icons/react": "Набір іконок Phosphor. Майже кожна іконка в CRM — звідси (через components/icons/appIcons).",
  ...
  xlsx: "Читає ексельки клієнтів прямо в браузері: з них імпортуються позиції прорахунку. Береться з офіційного CDN SheetJS, а не з npm, — у npm лишилась версія 2022 року з дірками розбору, а розбираємо ми саме чужі файли.",
  ...
  "@number-flow/react": "Крутить великі підсумки розряд за розрядом, коли сума міняється: «Витрати», картки «Огляду», сума прорахунку, лічильники «Релізів».",
  ...
  "@babel/parser": "Читає наш власний код як дерево, а не як текст. Потрібен перевірці, що звіряє кожен виклик до бази з тим, що в базі справді є: регулярки на цьому спотикались об згадку виклику в коментарі.",
  ...
  "@playwright/test":
    "Ганяє зібраний застосунок у справжньому браузері й клацає по ньому, як людина: відкриває дошки, закриває вікна, шукає. Ловить те, чого не бачить жоден тест коду, — наприклад блимання сторінки при закритті вікна.",
