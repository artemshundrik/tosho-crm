...
export function AccessOverview({
  ...
  return (
    ...
    /**
     * Вужче за повну ширину — як «Релізи» й «Стек».
     *
     * Даних тут мало: три числа, пʼять рядків контурів і стрічка. На 27"
     * аватарки контуру опинялись за пів екрана від назви модуля, а рядок
     * стрічки розтягувався так, що дата губилась праворуч.
     */
    <div className="mx-auto flex w-full max-w-[1180px] flex-col gap-4 px-4 pb-10 pt-4">
