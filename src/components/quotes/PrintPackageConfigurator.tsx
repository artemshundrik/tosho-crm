        ...
        <>
          ...
          {config.packageType === "custom" ? (
            <div className="grid gap-4 border-t border-border/40 pt-5 md:grid-cols-3">
              <ConfigField label="Ширина, мм">
                <Input type="number" value={config.widthMm} onChange={(e) => onConfigChange((prev) => ({ ...prev, widthMm: e.target.value }))} placeholder="0" />
              </ConfigField>
              <ConfigField label="Висота, мм">
                <Input type="number" value={config.heightMm} onChange={(e) => onConfigChange((prev) => ({ ...prev, heightMm: e.target.value }))} placeholder="0" />
              </ConfigField>
              <ConfigField label="Довжина, мм">
                <Input type="number" value={config.lengthMm} onChange={(e) => onConfigChange((prev) => ({ ...prev, lengthMm: e.target.value }))} placeholder="0" />
              </ConfigField>
            </div>
          ) : null}
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              ...
              {config.printType === "pantone" || config.printType === "cmyk_pantone" ? (
                <ConfigField label="Кількість пантонів">
                  <Input type="number" value={config.pantoneCount} onChange={(e) => onConfigChange((prev) => ({ ...prev, pantoneCount: e.target.value }))} placeholder="0" />
                </ConfigField>
              ) : null}
