...
export function buildCardMeta(request: DevRequest, options: CardMetaOptions = {}): CardMeta[] {
  ...
  // Напрямку немає — чіпа немає. Порожнє поле на картці нічого не додає: воно
  // однакове на десятках карток і витісняє з ряду те, що справді розрізняє.
  // Що напрямок не проставлений, видно в дровері й у фільтрі.
