 ...
 * колонки: її мінімум — 224 px (`QUOTES_COLUMN_WIDTH` у lib/kanbanColumnWidth),
 * і мінус відступи картки й блоку лишає приблизно 168 пікселів. П'ять мініатюр по 28 з проміжками — 156, і це
