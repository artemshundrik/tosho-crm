...
export type QuoteImportDraftItem = {
  ...
  /**
   * Вартість товару за одиницю, коли джерело її знає (REQ-250). Тільки НАША
   * ціна: у пулі це `price_kind = 'wholesale'`, тобто вже з урахуванням
   * домовленості. Роздрібну сюди не кладемо — чуже число в собівартості гірше
   * за порожнє поле, бо його ніхто не перевіряє очима.
   */
