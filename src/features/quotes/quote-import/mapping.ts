 ...
 *
 * `unit_price_model_vat` лишається ПОРОЖНІМ навіть із заповненою ціною, і це
 * навмисно. Позначка «з ПДВ чи без» — факт про гроші, а джерела кажуть різне:
 * у Тотобі ціни з ПДВ, у Бергамо це ніде не записано. Вигадати її не можна,
 * тож на неї питає наявний гейт (REQ-232) — рівно тоді, коли ціна є.
 *
