 ...
 *
 * ВАРТІСТЬ ТОВАРУ ТУТ НУЛЬ ЗАВЖДИ, навіть коли ціна нам відома. Її ставить
 * база окремим кроком, прочитавши рядок пулу (`set_quote_run_cost_from_pool`):
 * число, надіслане браузером, — це число від людини, і гейт посад слушно його
 * зупиняє. Разом із ціною база ставить і позначку «з ПДВ».
 *
 * `id` тиражу задаємо ТУТ, а не лишаємо базі: інакше після вставки ми не
 * знали б, якому саме рядку ставити ціну, і довелося б перечитувати тиражі.
 *
