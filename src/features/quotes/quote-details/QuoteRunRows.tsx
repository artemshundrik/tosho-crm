 ...
 * товару/од.» — 106 px, «47 612,67 UAH» — 109). Шапка й рядки — окремі гріди, тож
 ...
 * погодження тиражу зсувало б стовпчик сум убік. На єдиному тиражі вона стоїть
...
export function QuoteRunRows({
  ...
  /**
   * Чи є з чого ВИБИРАТИ. Погодження тиражу відповідає на питання «який із
   * варіантів узяв клієнт», і коли варіант один, питання немає: `pickApprovedRun`
   * бере єдиний тираж без позначки, блокер готовності замовлення
   * (`needsApprovedRunChoice`) на одному тиражі теж мовчить. Кнопка ж стояла
   * завжди — обов'язкова на вигляд дія, яка нічого не вирішує.
   *
   * Позначку з минулого це не ховає: нижче лишається бейдж. Зникає лише
   * пропозиція зробити вибір там, де вибору немає.
   */
              ...
              */}
              ...
              <span className="col-start-1 col-end-3 row-start-3 flex items-center justify-start lg:col-start-7 lg:col-end-8 lg:row-start-1 lg:justify-end">
                {/*
                  ...
                  І нема чого погоджувати, коли тираж один — див. `hasRunChoice`.
                */}
                {canApproveRun && hasRunChoice && (priced || isApproved) ? (
                  <button
                    type="button"
                    onClick={(event) => {
