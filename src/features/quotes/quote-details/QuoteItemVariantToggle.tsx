 ...
 * документі КП перестають складатись і показуються межами «від–до». ЧИСЛА
 * підсумку картки прапорець не міняє — як не міняє чисел замовлення й
 * дайджестів; поруч із підсумком лише з'являється окремий рядок «з них
 * варіанти: від X до Y», щоб менеджер бачив ті самі межі, що й клієнт. Див.
 * `@/lib/quoteItemVariants`.
 */
