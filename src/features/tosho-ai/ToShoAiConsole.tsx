...
// Wordmark переїхав у власний модуль (див. коментар там) — щоб шапка шторки
// не тягнула всю консоль у головний чанк. Re-export для сумісності.
export { ToShoAiWordmark } from "./ToShoAiWordmark";
                    ...
                    {analytics.kind === "people" ? (
                      ...
                      isQuoteDraft ? (
                        <img
                          src={row.avatarUrl}
                          alt=""
                          className="mt-0.5 h-16 w-16 shrink-0 rounded-xl border border-border/60 bg-background/80 object-cover sm:h-[72px] sm:w-[72px]"
                          loading="lazy"
                        />
                      ) : (
                        <EntityAvatar
