...
import { AlertTriangle, TrendingUp } from "@/components/icons/appIcons";
...
function Row({
  ...
  return (
    <div
      className={cn(
        "flex items-center justify-between gap-3 rounded-xl border border-border/40 bg-card px-4 py-2.5",
        muted && "flag-warning"
      )}
    >
