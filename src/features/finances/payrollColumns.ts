 ...
 * зайву ширину на широкій панелі, а на мінімальній (1290) лишається 142px —
 ...
 *
 * Середина — вісім колонок з полями, кожна під своє найширше (заміряно в
 * браузері 18.09.2026; поле має 22px відступів і рамки, клітинка — 16):
 * «Штраф» — «1 490,13» 53px → 92; «Бонус» — «18 664,17» 60px → 100 (на 96 такі
 * суми обрізались); «Особисте замовлення» й «Податки» тримає підпис у шапці —
 * 70 і 63px → 100 і 96. «АЗП» і «Аванс» ще несуть чип дати (52px зліва) → 136.
 * Разом 856.
 *
...
export const PAYROLL_COLUMNS: readonly PayrollColumn[] = [
  ...
  { key: "bonus", label: "Бонус", width: "w-[100px]", align: "", cell: "input" },
