 ...
 * — відомість ширша за панель (1306px проти ~918 на 1440), і прокручуватись
 ...
 * 142 («Співробітник») + 872 (вісім колонок середини) + 292 (підсумок).
 */
const TABLE_MIN_WIDTH = "min-w-[1306px]";
