...
export type FinanceExpense = {
  ...
  /**
   * Журнальна витрата, рахунок за яку приходить НАСТУПНОГО місяця (комуналка:
   * за вересень — 6–8 жовтня). Її місяць закривається 10-го числа наступного, а
   * не 25-го й не 5-го, як у води чи прибирання (REQ-314, `monthClose.ts`).
   */
