...
function AddressDemo() {
  ...
  return (
    <div className="grid gap-2.5 p-3.5">
      ...
      />
      <p className="text-3xs leading-4 text-muted-foreground">
        Довідник Нової Пошти, а в ньому вся Україна — не лише їхні відділення. Порядок
        такий: <b>спершу місто, потім вулиця</b>.
      </p>
      <p className="text-3xs leading-4 text-muted-foreground">
        Якщо підказок немає взагалі — довідник відповідає з сервера, і на локальному
        <code className="mx-1 font-mono">npm run dev</code> він не піднятий. У проді працює.
      </p>
    </div>
  );
}
