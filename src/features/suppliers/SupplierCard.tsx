  ...
  return (
    ...
    >
      ...
      <p className="truncate text-xs text-muted-foreground">
        {definition.sells} · {SUPPLIER_INTAKE_LABEL[definition.intake.kind]},{" "}
        {definition.platform}
      </p>
      ...
      <div className="-mx-4 border-b border-border/60 px-4 pb-3">
        <div
          className={cn(
            "flex items-start gap-2 rounded-inner border px-2.5 py-2",
            toneSubtleClass[plateTone],
          )}
        >
          <StateIcon
            className={cn(
              "mt-0.5 h-3.5 w-3.5 shrink-0",
              toneTextClass[plateTone],
            )}
            aria-hidden="true"
          />
          <p
