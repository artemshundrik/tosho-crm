...
export const SUPPLIER_DEFINITIONS: readonly SupplierDefinition[] = [
  ...
  },
  {
    ...
    price: {
      ...
      agreedOn: null,
      vat: "Чи ціни з ПДВ — у прайсі й на порталі не сказано; питання відкрите з 09.09.2026.",
    },
    ...
    quirks: [
      ...
      "Фото в прайсі немає: ім'я файлу — внутрішній id товару, і мапа «артикул → id» збирається окремим проходом по сторінках розділів.",
    ...
    inQuoteSearch: false,
    searchNote:
      "Залито в пул, у пошук не додано: рішення про перетин з іншими джерелами за Артемом. Три чверті прайсу — канцтовари, школа й творчість, і в пошуку промо-продукції вони можуть бути шумом.",
  },
  {
    id: "eney",
    slug: "eney.com.ua",
