...
export const SUPPLIER_DEFINITIONS: readonly SupplierDefinition[] = [
  ...
  },
  {
    ...
    intake: {
      kind: "crawl",
      summary:
        "Обхід 4367 сторінок товару під логіном: точки фіда google_base і google_sitemap віддають 200 і нуль байтів — розширення стоїть, вивантаження вимкнено в їхній адмінці.",
      schedule: "weekly",
      scheduleNote:
    ...
    price: {
      basis: "account",
      summary:
        "Сайт показує нашу ціну сам, щойно зайшли в кабінет, і поруч закреслює роздріб. Знижка рівна — 30% на весь каталог: 50 заміряних товарів із різних розділів дали множник 0,70 із розкидом 0,6889–0,7000, і весь він від округлення до копійок. Кабінет каже те саме числом.",
      agreedOn: "2026-09-10",
      vat: "Ціни на сайті з ПДВ, тому й наші з ПДВ.",
    },
