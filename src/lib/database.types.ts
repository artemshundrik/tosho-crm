  ...
  tosho: {
    Tables: {
      ...
      employee_pay_defaults: {
        ...
        Relationships: [
          {
            foreignKeyName: "designer_pay_defaults_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: true
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      employee_pay_month_close: {
        Row: {
          base_uah: number
          closed_at: string
          closed_by: string | null
          creatives_uah: number
          details: Json
          layout_over_uah: number
          month: string
          over_norm_uah: number
          total_uah: number
          user_id: string
          visual_over_uah: number
          workspace_id: string
        }
        Insert: {
          base_uah?: number
        ...
        Relationships: [
          {
            foreignKeyName: "designer_pay_month_close_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      employee_pay_rates: {
        Row: {
          base_month_rate: number
          created_at: string
          created_by: string | null
          creative_percent: number | null
          effective_from: string
          id: string
          layout_norm_per_day: number | null
          layout_over_rate: number | null
          note: string | null
          user_id: string
          visual_norm_per_day: number | null
          visual_over_rate: number | null
          workspace_id: string
        }
        Insert: {
          base_month_rate: number
        ...
        Relationships: [
          {
            foreignKeyName: "designer_pay_rates_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      ua_workday_exceptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "ua_workday_exceptions_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_admin_digest_metrics: { Args: never; Returns: Json }
