...
export const FEATURE_DEFINITIONS: readonly FeatureDefinition[] = [
  {
    ...
    category: "core",
    summary:
      "Робочі сповіщення приходять у звичайний чат: дедлайни, нагадування по клієнтах, коментарі, події команди. Кожну категорію можна вимкнути окремо, а вночі бот мовчить.",
    steps: [
      "Профіль → «Сповіщення» → «Підключити Telegram», далі Start у боті",
      "Обери, про що писати: у CRM або командою /settings просто в чаті",
      "Кнопки в боті й перемикачі в CRM — це одні й ті самі налаштування",
    ],
    moduleKey: null,
    route: "/profile",
    measurable: true,
  ...
  },
  {
    ...
    category: "ai",
    summary:
      "Той самий бот відповідає на питання: скільки задач у роботі, хто чим завантажений, що прострочено, яка воронка. Ним же можна оформити лікарняний чи відпустку, не заходячи в CRM.",
    steps: [
      "Напиши боту питання звичайною мовою — «що горить сьогодні»",
      "Не пам'ятаєш формулювань — надішли /help, він покаже всі приклади",
      "«Хворію» чи «відпустка 12.08–19.08» одразу створять заявку на погодження",
    ],
    moduleKey: null,
    route: "/profile",
