...
export async function searchSupplierPool(
  ...
  // дістається КОЖНОМУ (3 джерела × 200). Груп це вистачає з запасом —
  ...
  // Ціна питання — 29 кБ проти 175 кБ на запит, тобто рівно стільки, скільки
  // вже качає вітрина в поповері.
