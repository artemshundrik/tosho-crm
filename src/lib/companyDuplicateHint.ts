...
export type CompanyHintCandidate = {
  ...
  /**
   * Логотип самої компанії.
   *
   * Він відповідає на ПЕРШЕ питання людини — «це та сама компанія?» — швидше за
   * будь-який текст: помаранчеве коло KMZ упізнається з півпогляду. Аватарка
   * менеджера відповідає на друге, «до кого йти», і одне одного не заміняє.
   */
  logoUrl?: string | null;
};
