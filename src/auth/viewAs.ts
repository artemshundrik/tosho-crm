 ...
 *    когось;
 *  • «приміряти посаду» (owner і SEO) — інтерфейс посади без конкретної
 *    людини, дії дозволені: так СЕО може проклацати CRM у шкірі продакта чи
 ...
 * нічого (він і так має все), а СЕО не може через «приміряв owner» отримати
