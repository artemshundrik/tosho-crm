  ...
  return (
    <PageCanvas>
      <PageCanvasBody className="space-y-6 px-5 py-3 pb-20 md:pb-6">
        <section className="overflow-hidden rounded-xl border border-border/60 bg-[radial-gradient(circle_at_top_left,hsl(var(--primary)/0.18),transparent_34%),radial-gradient(circle_at_top_right,hsl(var(--success-foreground)/0.12),transparent_28%),linear-gradient(180deg,hsl(var(--card)/0.98),hsl(var(--muted)/0.45))] p-5">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              {latest ? (
                <div className="rounded-xl border border-border/60 bg-background/80 px-4 py-3 text-sm text-muted-foreground backdrop-blur">
                  Останній snapshot:{" "}
        ...
        {loading ? (
          ...
          <section className="rounded-xl border border-border/60 bg-card/95 p-8">
            <div className="mx-auto max-w-2xl text-center">
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-xl border border-border/70 bg-muted/40">
          ...
          <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as "overview" | "attachments" | "backups" | "telegram" | "errors" | "ai-usage")} className="w-full">
            {refreshError ? (
              <section className="mb-6 rounded-xl border border-warning-soft-border bg-warning-soft/80 p-4">
                <div className="flex items-start gap-3">
            ...
            <Suspense
              fallback={
                <section className="mt-6 rounded-xl border border-border/60 bg-card/95">
