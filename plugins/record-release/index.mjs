 ...
 * звіті; провалений деплой коштує викочування — люди не отримують готове, і хтось
 * мусить пушити ще раз (самé падіння кредитів не їсть, платиться лише успішний
 * деплой). Тому всі помилки тут — попередження, а не збій.
 */
