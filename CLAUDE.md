...
`QuoteDetailsPage.tsx` (~6860 рядків), `DesignTaskPage.tsx` (~12864), `QuotesPage.tsx` (~6951), `DesignPage.tsx` (~5937) — станом на 26.09.2026. `Read` ріже по 2000 рядків, тож стрибай за офсетами з [docs/LARGE_FILES_MAP.md](docs/LARGE_FILES_MAP.md), а не скануй з першого рядка.
