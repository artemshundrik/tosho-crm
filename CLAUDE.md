...
`QuoteDetailsPage.tsx` (~6763 рядків), `DesignTaskPage.tsx` (~12834), `QuotesPage.tsx` (~8310), `DesignPage.tsx` (~5958) — станом на 10.09.2026. `Read` ріже по 2000 рядків, тож стрибай за офсетами з [docs/LARGE_FILES_MAP.md](docs/LARGE_FILES_MAP.md), а не скануй з першого рядка.
