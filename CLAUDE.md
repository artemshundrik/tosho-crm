...
`QuoteDetailsPage.tsx` (~7540 рядків), `DesignTaskPage.tsx` (~12863), `QuotesPage.tsx` (~8309), `DesignPage.tsx` (~5985) — станом на 04.09.2026. `Read` ріже по 2000 рядків, тож стрибай за офсетами з [docs/LARGE_FILES_MAP.md](docs/LARGE_FILES_MAP.md), а не скануй з першого рядка.
