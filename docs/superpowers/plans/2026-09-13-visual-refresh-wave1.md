...
- [ ] **Step 3:** Звіт: «накопичено N комітів, готові до викочування» зі списком тем; нагадати, що після деплою Артем запускає `/design-sync`; `REQ-271#p3` (компактність) лишається відкритим.
